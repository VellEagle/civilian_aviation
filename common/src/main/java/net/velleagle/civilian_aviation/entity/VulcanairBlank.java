...
public class VulcanairBlank extends CivilianAircraftEntity {
    ...
    public VulcanairBlank(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.VULCANAIR_BLANK_ITEM.get();
    }
