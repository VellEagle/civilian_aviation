...
public class VulcanairRedsnail extends CivilianAircraftEntity {
    ...
    public VulcanairRedsnail(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.VULCANAIR_REDSNAIL_ITEM.get();
    }
