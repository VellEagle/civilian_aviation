...
public class SkyhawkPrBlackorange extends CivilianAircraftEntity {
    ...
    public SkyhawkPrBlackorange(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.SKYHAWK_PR_BLACKORANGE_ITEM.get();
    }
