...
public class SkyhawkCoffee extends CivilianAircraftEntity {
    ...
    public SkyhawkCoffee(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.SKYHAWK_COFFEE_ITEM.get();
    }
