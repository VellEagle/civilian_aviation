...
public class TrimotorWhite extends CivilianAircraftEntity {
    ...
    public TrimotorWhite(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.TRIMOTOR_WHITE_ITEM.get();
    }
