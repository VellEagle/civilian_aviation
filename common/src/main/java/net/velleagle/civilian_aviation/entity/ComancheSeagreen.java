 ...
 */
public class ComancheSeagreen extends CivilianAircraftEntity {
    ...
    private static final EntityDataAccessor<Boolean> GEAR_DEPLOYED =
            SynchedEntityData.defineId(ComancheSeagreen.class, EntityDataSerializers.BOOLEAN);
    ...
    public ComancheSeagreen(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.COMANCHE_SEAGREEN_ITEM.get();
    }
