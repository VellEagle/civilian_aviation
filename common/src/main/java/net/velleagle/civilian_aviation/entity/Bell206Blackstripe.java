...
public class Bell206Blackstripe extends HelicopterEntity {

    public Bell206Blackstripe(EntityType<? extends AircraftEntity> entityType, Level world) {
        super(entityType, world);
    }

    @Override
    public Item asItem() {
        return CivilianAviation.BELL206_BLACKSTRIPE_ITEM.get();
    }
    ...
    /**
     * 乗車した瞬間に door_l を閉める。
     * door_r / sidedoor_l / sidedoor_r はエンジン始動時に自動クローズ。
     */
    @Override
    ...
    // ---- door_l（パイロット席側・前方ドア左） ---------------
    // ※ 数値はモデルのローカル座標に合わせて調整してください
