 ...
 */
public class ComancheBlank extends CivilianAircraftEntity {
    ...
    private static final EntityDataAccessor<Boolean> GEAR_DEPLOYED =
            SynchedEntityData.defineId(ComancheBlank.class, EntityDataSerializers.BOOLEAN);
    ...
    public ComancheBlank(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.COMANCHE_BLANK_ITEM.get();
    }
