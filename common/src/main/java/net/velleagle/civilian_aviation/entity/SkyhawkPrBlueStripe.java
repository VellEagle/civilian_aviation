...
public class SkyhawkPrBlueStripe extends CivilianAircraftEntity {
    ...
    public SkyhawkPrBlueStripe(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.SKYHAWK_PR_BLUESTRIPE_ITEM.get();
    }
