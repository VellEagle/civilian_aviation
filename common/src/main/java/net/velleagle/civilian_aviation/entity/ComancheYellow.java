 ...
 */
public class ComancheYellow extends CivilianAircraftEntity {
    ...
    private static final EntityDataAccessor<Boolean> GEAR_DEPLOYED =
            SynchedEntityData.defineId(ComancheYellow.class, EntityDataSerializers.BOOLEAN);
    ...
    public ComancheYellow(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.COMANCHE_YELLOW_ITEM.get();
    }
