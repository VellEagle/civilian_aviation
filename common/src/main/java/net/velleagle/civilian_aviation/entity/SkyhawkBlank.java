...
public class SkyhawkBlank extends CivilianAircraftEntity {
    ...
    public SkyhawkBlank(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.SKYHAWK_BLANK_ITEM.get();
    }
