...
public class Bell206Orange extends HelicopterEntity {

    public Bell206Orange(EntityType<? extends AircraftEntity> entityType, Level world) {
        super(entityType, world);
    }

    @Override
    public Item asItem() {
        return CivilianAviation.BELL206_ORANGE_ITEM.get();
    }
