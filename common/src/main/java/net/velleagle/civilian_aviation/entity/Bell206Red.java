...
public class Bell206Red extends HelicopterEntity {

    public Bell206Red(EntityType<? extends AircraftEntity> entityType, Level world) {
        super(entityType, world);
    }

    @Override
    public Item asItem() {
        return CivilianAviation.BELL206_RED_ITEM.get();
    }
