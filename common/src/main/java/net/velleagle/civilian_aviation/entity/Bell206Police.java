...
public class Bell206Police extends HelicopterEntity {

    public Bell206Police(EntityType<? extends AircraftEntity> entityType, Level world) {
        super(entityType, world);
    }

    @Override
    public Item asItem() {
        return CivilianAviation.BELL206_POLICE_ITEM.get();
    }
