...
public class Bell206Skyblue extends HelicopterEntity {

    public Bell206Skyblue(EntityType<? extends AircraftEntity> entityType, Level world) {
        super(entityType, world);
    }

    @Override
    public Item asItem() {
        return CivilianAviation.BELL206_SKYBLUE_ITEM.get();
    }
