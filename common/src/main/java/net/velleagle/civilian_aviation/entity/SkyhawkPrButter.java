...
public class SkyhawkPrButter extends CivilianAircraftEntity {
    ...
    public SkyhawkPrButter(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.SKYHAWK_PR_BUTTER_ITEM.get();
    }
