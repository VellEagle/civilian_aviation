...
public class VulcanairWinged extends CivilianAircraftEntity {
    ...
    public VulcanairWinged(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.VULCANAIR_WINGED_ITEM.get();
    }
