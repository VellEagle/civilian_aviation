...
public class Bell206Blue extends HelicopterEntity {

    public Bell206Blue(EntityType<? extends AircraftEntity> entityType, Level world) {
        super(entityType, world);
    }

    @Override
    public Item asItem() {
        return CivilianAviation.BELL206_BLUE_ITEM.get();
    }
