...
public class VulcanairYellow extends CivilianAircraftEntity {
    ...
    public VulcanairYellow(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.VULCANAIR_YELLOW_ITEM.get();
    }
