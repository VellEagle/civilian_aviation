 ...
 */
public class ComancheBlackredstripe extends CivilianAircraftEntity {
    ...
    private static final EntityDataAccessor<Boolean> GEAR_DEPLOYED =
            SynchedEntityData.defineId(ComancheBlackredstripe.class, EntityDataSerializers.BOOLEAN);
    ...
    public ComancheBlackredstripe(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.COMANCHE_BLACKREDSTRIPE_ITEM.get();
    }
