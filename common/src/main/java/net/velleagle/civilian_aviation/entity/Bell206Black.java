...
public class Bell206Black extends HelicopterEntity {

    public Bell206Black(EntityType<? extends AircraftEntity> entityType, Level world) {
        super(entityType, world);
    }

    @Override
    public Item asItem() {
        return CivilianAviation.BELL206_BLACK_ITEM.get();
    }
