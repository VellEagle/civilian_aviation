...
public class SkyhawkPrRed extends CivilianAircraftEntity {
    ...
    public SkyhawkPrRed(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    protected float[][] getTrailPositions() {
        ...
        return new float[][] {
                { -6.818f,  2.48f,  -0.55f,  0.15f },  // 左翼端
                {  6.818f,  2.48f,  -0.55f,  0.15f },  // 右翼端
        };
    }

    @Override
    protected List<Trail> createTrails() {
        // SkyhawkPr: 左右翼端コントレイル
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.SKYHAWK_PR_RED_ITEM.get();
    }
