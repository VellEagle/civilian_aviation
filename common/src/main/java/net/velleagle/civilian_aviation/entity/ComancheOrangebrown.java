 ...
 */
public class ComancheOrangebrown extends CivilianAircraftEntity {
    ...
    private static final EntityDataAccessor<Boolean> GEAR_DEPLOYED =
            SynchedEntityData.defineId(ComancheOrangebrown.class, EntityDataSerializers.BOOLEAN);
    ...
    public ComancheOrangebrown(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.COMANCHE_ORANGEBROWN_ITEM.get();
    }
