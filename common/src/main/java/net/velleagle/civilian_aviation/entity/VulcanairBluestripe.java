...
public class VulcanairBluestripe extends CivilianAircraftEntity {
    ...
    public VulcanairBluestripe(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.VULCANAIR_BLUESTRIPE_ITEM.get();
    }
