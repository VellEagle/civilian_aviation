...
public class SkyhawkPrBlackred extends CivilianAircraftEntity {
    ...
    public SkyhawkPrBlackred(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.SKYHAWK_PR_BLACKRED_ITEM.get();
    }
