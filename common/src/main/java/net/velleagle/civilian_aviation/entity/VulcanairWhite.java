...
public class VulcanairWhite extends CivilianAircraftEntity {
    ...
    public VulcanairWhite(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.VULCANAIR_WHITE_ITEM.get();
    }
