...
public class VulcanairBlackyellow extends CivilianAircraftEntity {
    ...
    public VulcanairBlackyellow(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.VULCANAIR_BLACKYELLOW_ITEM.get();
    }
