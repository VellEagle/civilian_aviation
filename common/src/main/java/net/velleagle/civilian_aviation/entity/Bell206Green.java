...
public class Bell206Green extends HelicopterEntity {

    public Bell206Green(EntityType<? extends AircraftEntity> entityType, Level world) {
        super(entityType, world);
    }

    @Override
    public Item asItem() {
        return CivilianAviation.BELL206_GREEN_ITEM.get();
    }
