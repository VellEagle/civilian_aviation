...
public class SkyhawkPrRed2 extends CivilianAircraftEntity {
    ...
    public SkyhawkPrRed2(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.SKYHAWK_PR_RED2_ITEM.get();
    }
