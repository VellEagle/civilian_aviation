...
public class SkyhawkBlueStripe extends CivilianAircraftEntity {
    ...
    public SkyhawkBlueStripe(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.SKYHAWK_BLUESTRIPE_ITEM.get();
    }
