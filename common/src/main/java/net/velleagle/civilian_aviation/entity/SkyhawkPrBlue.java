...
public class SkyhawkPrBlue extends CivilianAircraftEntity {
    ...
    public SkyhawkPrBlue(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.SKYHAWK_PR_BLUE_ITEM.get();
    }
