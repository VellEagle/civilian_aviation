...
public class VulcanairOrange extends CivilianAircraftEntity {
    ...
    public VulcanairOrange(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.VULCANAIR_ORANGE_ITEM.get();
    }
