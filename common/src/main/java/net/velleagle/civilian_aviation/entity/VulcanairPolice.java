...
public class VulcanairPolice extends CivilianAircraftEntity {
    ...
    public VulcanairPolice(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.VULCANAIR_POLICE_ITEM.get();
    }
