...
public class SkyhawkPrBluered extends CivilianAircraftEntity {
    ...
    public SkyhawkPrBluered(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.SKYHAWK_PR_BLUERED_ITEM.get();
    }
