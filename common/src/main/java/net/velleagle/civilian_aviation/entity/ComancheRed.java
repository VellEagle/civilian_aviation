 ...
 */
public class ComancheRed extends CivilianAircraftEntity {
    ...
    private static final EntityDataAccessor<Boolean> GEAR_DEPLOYED =
            SynchedEntityData.defineId(ComancheRed.class, EntityDataSerializers.BOOLEAN);
    ...
    public ComancheRed(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.COMANCHE_RED_ITEM.get();
    }
