...
public class SkyhawkPrBlackyellow extends CivilianAircraftEntity {
    ...
    public SkyhawkPrBlackyellow(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.SKYHAWK_PR_BLACKYELLOW_ITEM.get();
    }
