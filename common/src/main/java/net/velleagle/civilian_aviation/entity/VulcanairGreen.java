...
public class VulcanairGreen extends CivilianAircraftEntity {
    ...
    public VulcanairGreen(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.VULCANAIR_GREEN_ITEM.get();
    }
