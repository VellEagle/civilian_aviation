...
public class Bell47gBlue extends HelicopterEntity {

    public Bell47gBlue(EntityType<? extends AircraftEntity> entityType, Level world) {
        super(entityType, world);
    }

    @Override
    public Item asItem() {
        return CivilianAviation.BELL47G_BLUE_ITEM.get();
    }
