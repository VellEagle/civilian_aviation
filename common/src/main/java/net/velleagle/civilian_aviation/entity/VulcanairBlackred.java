...
public class VulcanairBlackred extends CivilianAircraftEntity {
    ...
    public VulcanairBlackred(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.VULCANAIR_BLACKRED_ITEM.get();
    }
