...
public class SkyhawkBlackred extends CivilianAircraftEntity {
    ...
    public SkyhawkBlackred(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.SKYHAWK_BLACKRED_ITEM.get();
    }
