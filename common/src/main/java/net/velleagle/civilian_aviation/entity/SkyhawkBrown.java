...
public class SkyhawkBrown extends CivilianAircraftEntity {
    ...
    public SkyhawkBrown(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.SKYHAWK_BROWN_ITEM.get();
    }
