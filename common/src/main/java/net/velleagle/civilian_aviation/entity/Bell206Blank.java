...
public class Bell206Blank extends HelicopterEntity {

    public Bell206Blank(EntityType<? extends AircraftEntity> entityType, Level world) {
        super(entityType, world);
    }

    @Override
    public Item asItem() {
        return CivilianAviation.BELL206_BLANK_ITEM.get();
    }
