...
public class Bell206Yellow extends HelicopterEntity {

    public Bell206Yellow(EntityType<? extends AircraftEntity> entityType, Level world) {
        super(entityType, world);
    }

    @Override
    public Item asItem() {
        return CivilianAviation.BELL206_YELLOW_ITEM.get();
    }
