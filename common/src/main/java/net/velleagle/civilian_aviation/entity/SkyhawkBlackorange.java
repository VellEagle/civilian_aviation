...
public class SkyhawkBlackorange extends CivilianAircraftEntity {
    ...
    public SkyhawkBlackorange(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.SKYHAWK_BLACKORANGE_ITEM.get();
    }
