...
public class Bell206Olive extends HelicopterEntity {

    public Bell206Olive(EntityType<? extends AircraftEntity> entityType, Level world) {
        super(entityType, world);
    }

    @Override
    public Item asItem() {
        return CivilianAviation.BELL206_OLIVE_ITEM.get();
    }
