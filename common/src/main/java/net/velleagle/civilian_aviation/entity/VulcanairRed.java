...
public class VulcanairRed extends CivilianAircraftEntity {
    ...
    public VulcanairRed(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    protected float[][] getTrailPositions() {
        ...
        return new float[][] {
            { -6.61f,  2.3f, -1.92f,  0.15f },  // 左エンジン
            {  6.61f,  2.3f, -1.92f,  0.15f },  // 右エンジン
        };
    }
    ...
    protected List<Trail> createTrails() {
        // VulcanairRed: 左右エンジンナセル後方コントレイル
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.VULCANAIR_RED_ITEM.get();
    }
