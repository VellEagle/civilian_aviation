...
public class Bell47gOlive extends HelicopterEntity {

    public Bell47gOlive(EntityType<? extends AircraftEntity> entityType, Level world) {
        super(entityType, world);
    }

    @Override
    public Item asItem() {
        return CivilianAviation.BELL47G_OLIVE_ITEM.get();
    }
