...
public class VulcanairBlue extends CivilianAircraftEntity {
    ...
    public VulcanairBlue(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.VULCANAIR_BLUE_ITEM.get();
    }
