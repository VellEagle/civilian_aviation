...
public class SkyhawkGreen extends CivilianAircraftEntity {
    ...
    public SkyhawkGreen(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.SKYHAWK_GREEN_ITEM.get();
    }
