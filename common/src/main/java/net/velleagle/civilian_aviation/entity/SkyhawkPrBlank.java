...
public class SkyhawkPrBlank extends CivilianAircraftEntity {
    ...
    public SkyhawkPrBlank(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.SKYHAWK_PR_BLANK_ITEM.get();
    }
