...
public class SkyhawkRed2 extends CivilianAircraftEntity {
    ...
    public SkyhawkRed2(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.SKYHAWK_RED2_ITEM.get();
    }
