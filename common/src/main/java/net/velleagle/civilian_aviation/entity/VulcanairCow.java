...
public class VulcanairCow extends CivilianAircraftEntity {
    ...
    public VulcanairCow(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.VULCANAIR_COW_ITEM.get();
    }
