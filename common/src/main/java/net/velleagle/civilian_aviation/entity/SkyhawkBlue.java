...
public class SkyhawkBlue extends CivilianAircraftEntity {
    ...
    public SkyhawkBlue(EntityType<? extends AircraftEntity> entityType, Level world) {
    ...
    @Override
    public Item asItem() {
        return CivilianAviation.SKYHAWK_BLUE_ITEM.get();
    }
