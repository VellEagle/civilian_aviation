...
import net.velleagle.civilian_aviation.entity.SkyhawkBlackyellow;

public class SkyhawkBlackyellowRenderer extends AircraftEntityRenderer<SkyhawkBlackyellow> {
    private static final ResourceLocation ID = CivilianAviation.locate("skyhawk_blackyellow");
    ...
    private final ModelPartRenderHandler<SkyhawkBlackyellow> model = new ModelPartRenderHandler<SkyhawkBlackyellow>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<SkyhawkBlackyellow>()
    ...
    public SkyhawkBlackyellowRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<SkyhawkBlackyellow> getModel(AircraftEntity entity) {
        return model;
    }
}
