...
import net.velleagle.civilian_aviation.entity.Bell47g;

public class Bell47gRenderer extends AircraftEntityRenderer<Bell47g> {
    private static final ResourceLocation ID = CivilianAviation.locate("bell47g");
    ...
    private final ModelPartRenderHandler<Bell47g> model = new ModelPartRenderHandler<Bell47g>()
            // 染色パーツ（変更なし）
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<Bell47g>()
    ...
    public Bell47gRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<Bell47g> getModel(AircraftEntity entity) {
        return model;
    }
}