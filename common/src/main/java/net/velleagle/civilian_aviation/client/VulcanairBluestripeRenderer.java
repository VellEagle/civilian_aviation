...
import net.velleagle.civilian_aviation.entity.VulcanairBluestripe;

public class VulcanairBluestripeRenderer extends AircraftEntityRenderer<VulcanairBluestripe> {
    private static final ResourceLocation ID = CivilianAviation.locate("vulcanair_bluestripe");
    ...
    private final ModelPartRenderHandler<VulcanairBluestripe> model = new ModelPartRenderHandler<VulcanairBluestripe>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<VulcanairBluestripe>()
    ...
    public VulcanairBluestripeRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<VulcanairBluestripe> getModel(AircraftEntity entity) {
        return model;
    }
}
