...
import net.velleagle.civilian_aviation.entity.Bell47gOlive;

public class Bell47gOliveRenderer extends AircraftEntityRenderer<Bell47gOlive> {
    private static final ResourceLocation ID = CivilianAviation.locate("bell47g_olive");
    ...
    private final ModelPartRenderHandler<Bell47gOlive> model = new ModelPartRenderHandler<Bell47gOlive>()
            ...
            .add("propeller_main", (model, object, vcp, entity, ms, light, time, mpr) -> {
                ...
                if (alpha > 0.0f) BBModelRenderer.renderObjectInner(model, object, ms, vcp, light, time, entity,
                        new ModelPartRenderHandler<Bell47gOlive>().vertexConsumerProvider(TRANSLUCENT_PROVIDER),
    ...
    public Bell47gOliveRenderer(EntityRendererProvider.Context context) { super(context); }
    @Override protected ModelPartRenderHandler<Bell47gOlive> getModel(AircraftEntity entity) { return model; }
}
