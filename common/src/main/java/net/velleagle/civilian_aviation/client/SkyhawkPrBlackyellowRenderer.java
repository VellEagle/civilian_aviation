...
import net.velleagle.civilian_aviation.entity.SkyhawkPrBlackyellow;

public class SkyhawkPrBlackyellowRenderer extends AircraftEntityRenderer<SkyhawkPrBlackyellow> {
    private static final ResourceLocation ID = CivilianAviation.locate("skyhawk_pr_blackyellow");
    ...
    private final ModelPartRenderHandler<SkyhawkPrBlackyellow> model = new ModelPartRenderHandler<SkyhawkPrBlackyellow>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<SkyhawkPrBlackyellow>()
    ...
    public SkyhawkPrBlackyellowRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<SkyhawkPrBlackyellow> getModel(AircraftEntity entity) {
        return model;
    }
}
