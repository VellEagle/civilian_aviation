...
import net.velleagle.civilian_aviation.entity.ComancheRed;

public class ComancheRedRenderer extends AircraftEntityRenderer<ComancheRed> {
    private static final ResourceLocation ID = CivilianAviation.locate("comanche_red");
    ...
    private final ModelPartRenderHandler<ComancheRed> model = new ModelPartRenderHandler<ComancheRed>()
            // 染色パーツ（変更なし）
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<ComancheRed>()
    ...
    public ComancheRedRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<ComancheRed> getModel(AircraftEntity entity) {
        return model;
    }
}