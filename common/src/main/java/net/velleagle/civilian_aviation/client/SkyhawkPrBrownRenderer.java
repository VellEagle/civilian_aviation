...
import net.velleagle.civilian_aviation.entity.SkyhawkPrBrown;

public class SkyhawkPrBrownRenderer extends AircraftEntityRenderer<SkyhawkPrBrown> {
    private static final ResourceLocation ID = CivilianAviation.locate("skyhawk_pr_brown");
    ...
    private final ModelPartRenderHandler<SkyhawkPrBrown> model = new ModelPartRenderHandler<SkyhawkPrBrown>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<SkyhawkPrBrown>()
    ...
    public SkyhawkPrBrownRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<SkyhawkPrBrown> getModel(AircraftEntity entity) {
        return model;
    }
}
