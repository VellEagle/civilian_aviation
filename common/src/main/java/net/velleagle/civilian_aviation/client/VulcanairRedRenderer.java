...
import net.velleagle.civilian_aviation.entity.VulcanairRed;

public class VulcanairRedRenderer extends AircraftEntityRenderer<VulcanairRed> {
    private static final ResourceLocation ID = CivilianAviation.locate("vulcanair_red");
    ...
    private final ModelPartRenderHandler<VulcanairRed> model = new ModelPartRenderHandler<VulcanairRed>()
            // 染色パーツ（変更なし）
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<VulcanairRed>()
    ...
    public VulcanairRedRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<VulcanairRed> getModel(AircraftEntity entity) {
        return model;
    }
}