...
import net.velleagle.civilian_aviation.entity.Pzl37LosBrown;

public class Pzl37LosBrownRenderer extends AircraftEntityRenderer<Pzl37LosBrown> {
    private static final ResourceLocation ID = CivilianAviation.locate("pzl37los_brown");
    ...
    private final ModelPartRenderHandler<Pzl37LosBrown> model = new ModelPartRenderHandler<Pzl37LosBrown>()
            ...
            .add("propeller_l2", (model, object, vcp, entity, ms, light, time, mpr) -> {
                ...
                if (alpha > 0.0f) BBModelRenderer.renderObjectInner(model, object, ms, vcp, light, time, entity,
                        new ModelPartRenderHandler<Pzl37LosBrown>().vertexConsumerProvider(TRANSLUCENT_PROVIDER),
    ...
    public Pzl37LosBrownRenderer(EntityRendererProvider.Context context) { super(context); }
    @Override protected ModelPartRenderHandler<Pzl37LosBrown> getModel(AircraftEntity entity) { return model; }
}
