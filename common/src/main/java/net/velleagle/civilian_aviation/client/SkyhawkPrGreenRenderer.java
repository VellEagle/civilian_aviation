...
import net.velleagle.civilian_aviation.entity.SkyhawkPrGreen;

public class SkyhawkPrGreenRenderer extends AircraftEntityRenderer<SkyhawkPrGreen> {
    private static final ResourceLocation ID = CivilianAviation.locate("skyhawk_pr_green");
    ...
    private final ModelPartRenderHandler<SkyhawkPrGreen> model = new ModelPartRenderHandler<SkyhawkPrGreen>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<SkyhawkPrGreen>()
    ...
    public SkyhawkPrGreenRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<SkyhawkPrGreen> getModel(AircraftEntity entity) {
        return model;
    }
}
