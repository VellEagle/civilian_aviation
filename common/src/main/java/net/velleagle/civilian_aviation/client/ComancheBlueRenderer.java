...
import net.velleagle.civilian_aviation.entity.ComancheBlue;

public class ComancheBlueRenderer extends AircraftEntityRenderer<ComancheBlue> {
    private static final ResourceLocation ID = CivilianAviation.locate("comanche_blue");
    ...
    private final ModelPartRenderHandler<ComancheBlue> model = new ModelPartRenderHandler<ComancheBlue>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<ComancheBlue>()
    ...
    public ComancheBlueRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<ComancheBlue> getModel(AircraftEntity entity) {
        return model;
    }
}
