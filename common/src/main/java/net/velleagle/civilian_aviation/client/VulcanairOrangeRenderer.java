...
import net.velleagle.civilian_aviation.entity.VulcanairOrange;

public class VulcanairOrangeRenderer extends AircraftEntityRenderer<VulcanairOrange> {
    private static final ResourceLocation ID = CivilianAviation.locate("vulcanair_orange");
    ...
    private final ModelPartRenderHandler<VulcanairOrange> model = new ModelPartRenderHandler<VulcanairOrange>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<VulcanairOrange>()
    ...
    public VulcanairOrangeRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<VulcanairOrange> getModel(AircraftEntity entity) {
        return model;
    }
}
