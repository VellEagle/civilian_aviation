...
import net.velleagle.civilian_aviation.entity.Bell206Skyblue;

public class Bell206SkyblueRenderer extends AircraftEntityRenderer<Bell206Skyblue> {
    private static final ResourceLocation ID = CivilianAviation.locate("bell206_skyblue");
    ...
    private final ModelPartRenderHandler<Bell206Skyblue> model = new ModelPartRenderHandler<Bell206Skyblue>()
            ...
            .add("propeller_main", (model, object, vcp, entity, ms, light, time, mpr) -> {
                ...
                if (alpha > 0.0f) BBModelRenderer.renderObjectInner(model, object, ms, vcp, light, time, entity,
                        new ModelPartRenderHandler<Bell206Skyblue>().vertexConsumerProvider(TRANSLUCENT_PROVIDER),
    ...
    public Bell206SkyblueRenderer(EntityRendererProvider.Context context) { super(context); }
    @Override protected ModelPartRenderHandler<Bell206Skyblue> getModel(AircraftEntity entity) { return model; }
}
