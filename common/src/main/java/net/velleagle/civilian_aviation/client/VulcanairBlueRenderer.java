...
import net.velleagle.civilian_aviation.entity.VulcanairBlue;

public class VulcanairBlueRenderer extends AircraftEntityRenderer<VulcanairBlue> {
    private static final ResourceLocation ID = CivilianAviation.locate("vulcanair_blue");
    ...
    private final ModelPartRenderHandler<VulcanairBlue> model = new ModelPartRenderHandler<VulcanairBlue>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<VulcanairBlue>()
    ...
    public VulcanairBlueRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<VulcanairBlue> getModel(AircraftEntity entity) {
        return model;
    }
}
