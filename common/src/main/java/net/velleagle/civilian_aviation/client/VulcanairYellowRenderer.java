...
import net.velleagle.civilian_aviation.entity.VulcanairYellow;

public class VulcanairYellowRenderer extends AircraftEntityRenderer<VulcanairYellow> {
    private static final ResourceLocation ID = CivilianAviation.locate("vulcanair_yellow");
    ...
    private final ModelPartRenderHandler<VulcanairYellow> model = new ModelPartRenderHandler<VulcanairYellow>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<VulcanairYellow>()
    ...
    public VulcanairYellowRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<VulcanairYellow> getModel(AircraftEntity entity) {
        return model;
    }
}
