...
import net.velleagle.civilian_aviation.entity.Bell206Green;

public class Bell206GreenRenderer extends AircraftEntityRenderer<Bell206Green> {
    private static final ResourceLocation ID = CivilianAviation.locate("bell206_green");
    ...
    private final ModelPartRenderHandler<Bell206Green> model = new ModelPartRenderHandler<Bell206Green>()
            ...
            .add("propeller_main", (model, object, vcp, entity, ms, light, time, mpr) -> {
                ...
                if (alpha > 0.0f) BBModelRenderer.renderObjectInner(model, object, ms, vcp, light, time, entity,
                        new ModelPartRenderHandler<Bell206Green>().vertexConsumerProvider(TRANSLUCENT_PROVIDER),
    ...
    public Bell206GreenRenderer(EntityRendererProvider.Context context) { super(context); }
    @Override protected ModelPartRenderHandler<Bell206Green> getModel(AircraftEntity entity) { return model; }
}
