...
import net.velleagle.civilian_aviation.entity.SkyhawkGreen;

public class SkyhawkGreenRenderer extends AircraftEntityRenderer<SkyhawkGreen> {
    private static final ResourceLocation ID = CivilianAviation.locate("skyhawk_green");
    ...
    private final ModelPartRenderHandler<SkyhawkGreen> model = new ModelPartRenderHandler<SkyhawkGreen>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<SkyhawkGreen>()
    ...
    public SkyhawkGreenRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<SkyhawkGreen> getModel(AircraftEntity entity) {
        return model;
    }
}
