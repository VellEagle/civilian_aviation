...
import net.velleagle.civilian_aviation.entity.VulcanairWhite;

public class VulcanairWhiteRenderer extends AircraftEntityRenderer<VulcanairWhite> {
    private static final ResourceLocation ID = CivilianAviation.locate("vulcanair_white");
    ...
    private final ModelPartRenderHandler<VulcanairWhite> model = new ModelPartRenderHandler<VulcanairWhite>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<VulcanairWhite>()
    ...
    public VulcanairWhiteRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<VulcanairWhite> getModel(AircraftEntity entity) {
        return model;
    }
}
