...
import net.velleagle.civilian_aviation.entity.VulcanairPolice;

public class VulcanairPoliceRenderer extends AircraftEntityRenderer<VulcanairPolice> {
    private static final ResourceLocation ID = CivilianAviation.locate("vulcanair_police");
    ...
    private final ModelPartRenderHandler<VulcanairPolice> model = new ModelPartRenderHandler<VulcanairPolice>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<VulcanairPolice>()
    ...
    public VulcanairPoliceRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<VulcanairPolice> getModel(AircraftEntity entity) {
        return model;
    }
}
