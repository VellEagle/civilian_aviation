...
import net.velleagle.civilian_aviation.entity.SkyhawkPrBlackorange;

public class SkyhawkPrBlackorangeRenderer extends AircraftEntityRenderer<SkyhawkPrBlackorange> {
    private static final ResourceLocation ID = CivilianAviation.locate("skyhawk_pr_blackorange");
    ...
    private final ModelPartRenderHandler<SkyhawkPrBlackorange> model = new ModelPartRenderHandler<SkyhawkPrBlackorange>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<SkyhawkPrBlackorange>()
    ...
    public SkyhawkPrBlackorangeRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<SkyhawkPrBlackorange> getModel(AircraftEntity entity) {
        return model;
    }
}
