...
import net.velleagle.civilian_aviation.entity.SkyhawkRed2;

public class SkyhawkRed2Renderer extends AircraftEntityRenderer<SkyhawkRed2> {
    private static final ResourceLocation ID = CivilianAviation.locate("skyhawk_red2");
    ...
    private final ModelPartRenderHandler<SkyhawkRed2> model = new ModelPartRenderHandler<SkyhawkRed2>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<SkyhawkRed2>()
    ...
    public SkyhawkRed2Renderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<SkyhawkRed2> getModel(AircraftEntity entity) {
        return model;
    }
}
