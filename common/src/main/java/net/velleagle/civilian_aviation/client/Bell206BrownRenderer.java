...
import net.velleagle.civilian_aviation.entity.Bell206Brown;

public class Bell206BrownRenderer extends AircraftEntityRenderer<Bell206Brown> {
    private static final ResourceLocation ID = CivilianAviation.locate("bell206_brown");
    ...
    private final ModelPartRenderHandler<Bell206Brown> model = new ModelPartRenderHandler<Bell206Brown>()
            ...
            .add("propeller_main", (model, object, vcp, entity, ms, light, time, mpr) -> {
                ...
                if (alpha > 0.0f) BBModelRenderer.renderObjectInner(model, object, ms, vcp, light, time, entity,
                        new ModelPartRenderHandler<Bell206Brown>().vertexConsumerProvider(TRANSLUCENT_PROVIDER),
    ...
    public Bell206BrownRenderer(EntityRendererProvider.Context context) { super(context); }
    @Override protected ModelPartRenderHandler<Bell206Brown> getModel(AircraftEntity entity) { return model; }
}
