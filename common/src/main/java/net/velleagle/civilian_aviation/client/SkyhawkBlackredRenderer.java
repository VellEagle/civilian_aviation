...
import net.velleagle.civilian_aviation.entity.SkyhawkBlackred;

public class SkyhawkBlackredRenderer extends AircraftEntityRenderer<SkyhawkBlackred> {
    private static final ResourceLocation ID = CivilianAviation.locate("skyhawk_blackred");
    ...
    private final ModelPartRenderHandler<SkyhawkBlackred> model = new ModelPartRenderHandler<SkyhawkBlackred>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<SkyhawkBlackred>()
    ...
    public SkyhawkBlackredRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<SkyhawkBlackred> getModel(AircraftEntity entity) {
        return model;
    }
}
