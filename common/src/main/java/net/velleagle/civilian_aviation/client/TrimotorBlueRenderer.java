...
import net.velleagle.civilian_aviation.entity.TrimotorBlue;

public class TrimotorBlueRenderer extends AircraftEntityRenderer<TrimotorBlue> {
    private static final ResourceLocation ID = CivilianAviation.locate("trimotor_blue");
    ...
    private final ModelPartRenderHandler<TrimotorBlue> model = new ModelPartRenderHandler<TrimotorBlue>()
            // 染色パーツ（変更なし）
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<TrimotorBlue>()
    ...
    public TrimotorBlueRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<TrimotorBlue> getModel(AircraftEntity entity) {
        return model;
    }
}