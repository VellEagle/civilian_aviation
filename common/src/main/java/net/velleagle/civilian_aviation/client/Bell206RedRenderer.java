...
import net.velleagle.civilian_aviation.entity.Bell206Red;

public class Bell206RedRenderer extends AircraftEntityRenderer<Bell206Red> {
    private static final ResourceLocation ID = CivilianAviation.locate("bell206_red");
    ...
    private final ModelPartRenderHandler<Bell206Red> model = new ModelPartRenderHandler<Bell206Red>()
            ...
            .add("propeller_main", (model, object, vcp, entity, ms, light, time, mpr) -> {
                ...
                if (alpha > 0.0f) BBModelRenderer.renderObjectInner(model, object, ms, vcp, light, time, entity,
                        new ModelPartRenderHandler<Bell206Red>().vertexConsumerProvider(TRANSLUCENT_PROVIDER),
    ...
    public Bell206RedRenderer(EntityRendererProvider.Context context) { super(context); }
    @Override protected ModelPartRenderHandler<Bell206Red> getModel(AircraftEntity entity) { return model; }
}
