...
import net.velleagle.civilian_aviation.entity.Pzl37LosTan;

public class Pzl37LosTanRenderer extends AircraftEntityRenderer<Pzl37LosTan> {
    private static final ResourceLocation ID = CivilianAviation.locate("pzl37los_tan");
    ...
    private final ModelPartRenderHandler<Pzl37LosTan> model = new ModelPartRenderHandler<Pzl37LosTan>()
            ...
            .add("propeller_l2", (model, object, vcp, entity, ms, light, time, mpr) -> {
                ...
                if (alpha > 0.0f) BBModelRenderer.renderObjectInner(model, object, ms, vcp, light, time, entity,
                        new ModelPartRenderHandler<Pzl37LosTan>().vertexConsumerProvider(TRANSLUCENT_PROVIDER),
    ...
    public Pzl37LosTanRenderer(EntityRendererProvider.Context context) { super(context); }
    @Override protected ModelPartRenderHandler<Pzl37LosTan> getModel(AircraftEntity entity) { return model; }
}
