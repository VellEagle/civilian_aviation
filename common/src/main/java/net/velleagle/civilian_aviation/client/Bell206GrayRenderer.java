...
import net.velleagle.civilian_aviation.entity.Bell206Gray;

public class Bell206GrayRenderer extends AircraftEntityRenderer<Bell206Gray> {
    private static final ResourceLocation ID = CivilianAviation.locate("bell206_gray");
    ...
    private final ModelPartRenderHandler<Bell206Gray> model = new ModelPartRenderHandler<Bell206Gray>()
            ...
            .add("propeller_main", (model, object, vcp, entity, ms, light, time, mpr) -> {
                ...
                if (alpha > 0.0f) BBModelRenderer.renderObjectInner(model, object, ms, vcp, light, time, entity,
                        new ModelPartRenderHandler<Bell206Gray>().vertexConsumerProvider(TRANSLUCENT_PROVIDER),
    ...
    public Bell206GrayRenderer(EntityRendererProvider.Context context) { super(context); }
    @Override protected ModelPartRenderHandler<Bell206Gray> getModel(AircraftEntity entity) { return model; }
}
