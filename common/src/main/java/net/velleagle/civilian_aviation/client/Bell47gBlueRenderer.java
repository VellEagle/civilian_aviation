...
import net.velleagle.civilian_aviation.entity.Bell47gBlue;

public class Bell47gBlueRenderer extends AircraftEntityRenderer<Bell47gBlue> {
    private static final ResourceLocation ID = CivilianAviation.locate("bell47g_blue");
    ...
    private final ModelPartRenderHandler<Bell47gBlue> model = new ModelPartRenderHandler<Bell47gBlue>()
            ...
            .add("propeller_main", (model, object, vcp, entity, ms, light, time, mpr) -> {
                ...
                if (alpha > 0.0f) BBModelRenderer.renderObjectInner(model, object, ms, vcp, light, time, entity,
                        new ModelPartRenderHandler<Bell47gBlue>().vertexConsumerProvider(TRANSLUCENT_PROVIDER),
    ...
    public Bell47gBlueRenderer(EntityRendererProvider.Context context) { super(context); }
    @Override protected ModelPartRenderHandler<Bell47gBlue> getModel(AircraftEntity entity) { return model; }
}
