...
import net.velleagle.civilian_aviation.entity.Pzlp11Tan;

public class Pzlp11TanRenderer extends AircraftEntityRenderer<Pzlp11Tan> {
    private static final ResourceLocation ID = CivilianAviation.locate("pzlp11_tan");
    ...
    private final ModelPartRenderHandler<Pzlp11Tan> model = new ModelPartRenderHandler<Pzlp11Tan>()
            ...
            .add("propeller_main", (model, object, vcp, entity, ms, light, time, mpr) -> {
                ...
                if (alpha > 0.0f) BBModelRenderer.renderObjectInner(model, object, ms, vcp, light, time, entity,
                        new ModelPartRenderHandler<Pzlp11Tan>().vertexConsumerProvider(TRANSLUCENT_PROVIDER),
    ...
    public Pzlp11TanRenderer(EntityRendererProvider.Context context) { super(context); }
    @Override protected ModelPartRenderHandler<Pzlp11Tan> getModel(AircraftEntity entity) { return model; }
}
