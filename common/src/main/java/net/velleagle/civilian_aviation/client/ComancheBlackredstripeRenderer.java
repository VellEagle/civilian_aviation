...
import net.velleagle.civilian_aviation.entity.ComancheBlackredstripe;

public class ComancheBlackredstripeRenderer extends AircraftEntityRenderer<ComancheBlackredstripe> {
    private static final ResourceLocation ID = CivilianAviation.locate("comanche_blackredstripe");
    ...
    private final ModelPartRenderHandler<ComancheBlackredstripe> model = new ModelPartRenderHandler<ComancheBlackredstripe>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<ComancheBlackredstripe>()
    ...
    public ComancheBlackredstripeRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<ComancheBlackredstripe> getModel(AircraftEntity entity) {
        return model;
    }
}
