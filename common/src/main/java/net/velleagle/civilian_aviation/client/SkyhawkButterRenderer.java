...
import net.velleagle.civilian_aviation.entity.SkyhawkButter;

public class SkyhawkButterRenderer extends AircraftEntityRenderer<SkyhawkButter> {
    private static final ResourceLocation ID = CivilianAviation.locate("skyhawk_butter");
    ...
    private final ModelPartRenderHandler<SkyhawkButter> model = new ModelPartRenderHandler<SkyhawkButter>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<SkyhawkButter>()
    ...
    public SkyhawkButterRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<SkyhawkButter> getModel(AircraftEntity entity) {
        return model;
    }
}
