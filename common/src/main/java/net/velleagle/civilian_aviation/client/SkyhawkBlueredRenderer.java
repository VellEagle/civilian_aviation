...
import net.velleagle.civilian_aviation.entity.SkyhawkBluered;

public class SkyhawkBlueredRenderer extends AircraftEntityRenderer<SkyhawkBluered> {
    private static final ResourceLocation ID = CivilianAviation.locate("skyhawk_bluered");
    ...
    private final ModelPartRenderHandler<SkyhawkBluered> model = new ModelPartRenderHandler<SkyhawkBluered>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<SkyhawkBluered>()
    ...
    public SkyhawkBlueredRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<SkyhawkBluered> getModel(AircraftEntity entity) {
        return model;
    }
}
