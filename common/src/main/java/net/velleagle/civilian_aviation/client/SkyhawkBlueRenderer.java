...
import net.velleagle.civilian_aviation.entity.SkyhawkBlue;

public class SkyhawkBlueRenderer extends AircraftEntityRenderer<SkyhawkBlue> {
    private static final ResourceLocation ID = CivilianAviation.locate("skyhawk_blue");
    ...
    private final ModelPartRenderHandler<SkyhawkBlue> model = new ModelPartRenderHandler<SkyhawkBlue>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<SkyhawkBlue>()
    ...
    public SkyhawkBlueRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<SkyhawkBlue> getModel(AircraftEntity entity) {
        return model;
    }
}
