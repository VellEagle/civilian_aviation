...
import net.velleagle.civilian_aviation.entity.VulcanairSeagreen;

public class VulcanairSeagreenRenderer extends AircraftEntityRenderer<VulcanairSeagreen> {
    private static final ResourceLocation ID = CivilianAviation.locate("vulcanair_seagreen");
    ...
    private final ModelPartRenderHandler<VulcanairSeagreen> model = new ModelPartRenderHandler<VulcanairSeagreen>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<VulcanairSeagreen>()
    ...
    public VulcanairSeagreenRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<VulcanairSeagreen> getModel(AircraftEntity entity) {
        return model;
    }
}
