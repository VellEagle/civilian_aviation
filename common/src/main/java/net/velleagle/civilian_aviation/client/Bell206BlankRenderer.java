...
import net.velleagle.civilian_aviation.entity.Bell206Blank;

public class Bell206BlankRenderer extends AircraftEntityRenderer<Bell206Blank> {
    private static final ResourceLocation ID = CivilianAviation.locate("bell206_blank");
    ...
    private final ModelPartRenderHandler<Bell206Blank> model = new ModelPartRenderHandler<Bell206Blank>()
            ...
            .add("propeller_main", (model, object, vcp, entity, ms, light, time, mpr) -> {
                ...
                if (alpha > 0.0f) BBModelRenderer.renderObjectInner(model, object, ms, vcp, light, time, entity,
                        new ModelPartRenderHandler<Bell206Blank>().vertexConsumerProvider(TRANSLUCENT_PROVIDER),
    ...
    public Bell206BlankRenderer(EntityRendererProvider.Context context) { super(context); }
    @Override protected ModelPartRenderHandler<Bell206Blank> getModel(AircraftEntity entity) { return model; }
}
