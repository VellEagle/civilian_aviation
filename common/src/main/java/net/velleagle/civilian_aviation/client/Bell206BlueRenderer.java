...
import net.velleagle.civilian_aviation.entity.Bell206Blue;

public class Bell206BlueRenderer extends AircraftEntityRenderer<Bell206Blue> {
    private static final ResourceLocation ID = CivilianAviation.locate("bell206_blue");
    ...
    private final ModelPartRenderHandler<Bell206Blue> model = new ModelPartRenderHandler<Bell206Blue>()
            ...
            .add("propeller_main", (model, object, vcp, entity, ms, light, time, mpr) -> {
                ...
                if (alpha > 0.0f) BBModelRenderer.renderObjectInner(model, object, ms, vcp, light, time, entity,
                        new ModelPartRenderHandler<Bell206Blue>().vertexConsumerProvider(TRANSLUCENT_PROVIDER),
    ...
    public Bell206BlueRenderer(EntityRendererProvider.Context context) { super(context); }
    @Override protected ModelPartRenderHandler<Bell206Blue> getModel(AircraftEntity entity) { return model; }
}
