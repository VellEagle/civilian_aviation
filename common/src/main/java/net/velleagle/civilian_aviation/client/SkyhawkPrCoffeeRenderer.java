...
import net.velleagle.civilian_aviation.entity.SkyhawkPrCoffee;

public class SkyhawkPrCoffeeRenderer extends AircraftEntityRenderer<SkyhawkPrCoffee> {
    private static final ResourceLocation ID = CivilianAviation.locate("skyhawk_pr_coffee");
    ...
    private final ModelPartRenderHandler<SkyhawkPrCoffee> model = new ModelPartRenderHandler<SkyhawkPrCoffee>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<SkyhawkPrCoffee>()
    ...
    public SkyhawkPrCoffeeRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<SkyhawkPrCoffee> getModel(AircraftEntity entity) {
        return model;
    }
}
