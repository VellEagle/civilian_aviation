...
import net.velleagle.civilian_aviation.entity.ComancheOrangebrown;

public class ComancheOrangebrownRenderer extends AircraftEntityRenderer<ComancheOrangebrown> {
    private static final ResourceLocation ID = CivilianAviation.locate("comanche_orangebrown");
    ...
    private final ModelPartRenderHandler<ComancheOrangebrown> model = new ModelPartRenderHandler<ComancheOrangebrown>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<ComancheOrangebrown>()
    ...
    public ComancheOrangebrownRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<ComancheOrangebrown> getModel(AircraftEntity entity) {
        return model;
    }
}
