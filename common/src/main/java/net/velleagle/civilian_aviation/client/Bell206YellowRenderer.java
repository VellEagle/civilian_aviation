...
import net.velleagle.civilian_aviation.entity.Bell206Yellow;

public class Bell206YellowRenderer extends AircraftEntityRenderer<Bell206Yellow> {
    private static final ResourceLocation ID = CivilianAviation.locate("bell206_yellow");
    ...
    private final ModelPartRenderHandler<Bell206Yellow> model = new ModelPartRenderHandler<Bell206Yellow>()
            ...
            .add("propeller_main", (model, object, vcp, entity, ms, light, time, mpr) -> {
                ...
                if (alpha > 0.0f) BBModelRenderer.renderObjectInner(model, object, ms, vcp, light, time, entity,
                        new ModelPartRenderHandler<Bell206Yellow>().vertexConsumerProvider(TRANSLUCENT_PROVIDER),
    ...
    public Bell206YellowRenderer(EntityRendererProvider.Context context) { super(context); }
    @Override protected ModelPartRenderHandler<Bell206Yellow> getModel(AircraftEntity entity) { return model; }
}
