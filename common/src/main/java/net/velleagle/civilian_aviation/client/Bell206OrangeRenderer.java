...
import net.velleagle.civilian_aviation.entity.Bell206Orange;

public class Bell206OrangeRenderer extends AircraftEntityRenderer<Bell206Orange> {
    private static final ResourceLocation ID = CivilianAviation.locate("bell206_orange");
    ...
    private final ModelPartRenderHandler<Bell206Orange> model = new ModelPartRenderHandler<Bell206Orange>()
            ...
            .add("propeller_main", (model, object, vcp, entity, ms, light, time, mpr) -> {
                ...
                if (alpha > 0.0f) BBModelRenderer.renderObjectInner(model, object, ms, vcp, light, time, entity,
                        new ModelPartRenderHandler<Bell206Orange>().vertexConsumerProvider(TRANSLUCENT_PROVIDER),
    ...
    public Bell206OrangeRenderer(EntityRendererProvider.Context context) { super(context); }
    @Override protected ModelPartRenderHandler<Bell206Orange> getModel(AircraftEntity entity) { return model; }
}
