...
import net.velleagle.civilian_aviation.entity.SkyhawkCoffee;

public class SkyhawkCoffeeRenderer extends AircraftEntityRenderer<SkyhawkCoffee> {
    private static final ResourceLocation ID = CivilianAviation.locate("skyhawk_coffee");
    ...
    private final ModelPartRenderHandler<SkyhawkCoffee> model = new ModelPartRenderHandler<SkyhawkCoffee>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<SkyhawkCoffee>()
    ...
    public SkyhawkCoffeeRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<SkyhawkCoffee> getModel(AircraftEntity entity) {
        return model;
    }
}
