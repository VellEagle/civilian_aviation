...
import net.velleagle.civilian_aviation.entity.SkyhawkPrBlank;

public class SkyhawkPrBlankRenderer extends AircraftEntityRenderer<SkyhawkPrBlank> {
    private static final ResourceLocation ID = CivilianAviation.locate("skyhawk_pr_blank");
    ...
    private final ModelPartRenderHandler<SkyhawkPrBlank> model = new ModelPartRenderHandler<SkyhawkPrBlank>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<SkyhawkPrBlank>()
    ...
    public SkyhawkPrBlankRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<SkyhawkPrBlank> getModel(AircraftEntity entity) {
        return model;
    }
}
