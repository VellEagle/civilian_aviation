...
import net.velleagle.civilian_aviation.entity.Pzlp11Green;

public class Pzlp11GreenRenderer extends AircraftEntityRenderer<Pzlp11Green> {
    private static final ResourceLocation ID = CivilianAviation.locate("pzlp11_green");
    ...
    private final ModelPartRenderHandler<Pzlp11Green> model = new ModelPartRenderHandler<Pzlp11Green>()
            ...
            .add("propeller_main", (model, object, vcp, entity, ms, light, time, mpr) -> {
                ...
                if (alpha > 0.0f) BBModelRenderer.renderObjectInner(model, object, ms, vcp, light, time, entity,
                        new ModelPartRenderHandler<Pzlp11Green>().vertexConsumerProvider(TRANSLUCENT_PROVIDER),
    ...
    public Pzlp11GreenRenderer(EntityRendererProvider.Context context) { super(context); }
    @Override protected ModelPartRenderHandler<Pzlp11Green> getModel(AircraftEntity entity) { return model; }
}
