...
import net.velleagle.civilian_aviation.entity.SkyhawkBlackorange;

public class SkyhawkBlackorangeRenderer extends AircraftEntityRenderer<SkyhawkBlackorange> {
    private static final ResourceLocation ID = CivilianAviation.locate("skyhawk_blackorange");
    ...
    private final ModelPartRenderHandler<SkyhawkBlackorange> model = new ModelPartRenderHandler<SkyhawkBlackorange>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<SkyhawkBlackorange>()
    ...
    public SkyhawkBlackorangeRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<SkyhawkBlackorange> getModel(AircraftEntity entity) {
        return model;
    }
}
