...
import net.velleagle.civilian_aviation.entity.VulcanairBlackyellow;

public class VulcanairBlackyellowRenderer extends AircraftEntityRenderer<VulcanairBlackyellow> {
    private static final ResourceLocation ID = CivilianAviation.locate("vulcanair_blackyellow");
    ...
    private final ModelPartRenderHandler<VulcanairBlackyellow> model = new ModelPartRenderHandler<VulcanairBlackyellow>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<VulcanairBlackyellow>()
    ...
    public VulcanairBlackyellowRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<VulcanairBlackyellow> getModel(AircraftEntity entity) {
        return model;
    }
}
