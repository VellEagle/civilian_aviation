...
import net.velleagle.civilian_aviation.entity.VulcanairRedsnail;

public class VulcanairRedsnailRenderer extends AircraftEntityRenderer<VulcanairRedsnail> {
    private static final ResourceLocation ID = CivilianAviation.locate("vulcanair_redsnail");
    ...
    private final ModelPartRenderHandler<VulcanairRedsnail> model = new ModelPartRenderHandler<VulcanairRedsnail>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<VulcanairRedsnail>()
    ...
    public VulcanairRedsnailRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<VulcanairRedsnail> getModel(AircraftEntity entity) {
        return model;
    }
}
