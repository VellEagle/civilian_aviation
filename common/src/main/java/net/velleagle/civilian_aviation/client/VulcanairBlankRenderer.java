...
import net.velleagle.civilian_aviation.entity.VulcanairBlank;

public class VulcanairBlankRenderer extends AircraftEntityRenderer<VulcanairBlank> {
    private static final ResourceLocation ID = CivilianAviation.locate("vulcanair_blank");
    ...
    private final ModelPartRenderHandler<VulcanairBlank> model = new ModelPartRenderHandler<VulcanairBlank>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<VulcanairBlank>()
    ...
    public VulcanairBlankRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<VulcanairBlank> getModel(AircraftEntity entity) {
        return model;
    }
}
