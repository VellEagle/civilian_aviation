...
import net.velleagle.civilian_aviation.entity.Bell206Black;

public class Bell206BlackRenderer extends AircraftEntityRenderer<Bell206Black> {
    private static final ResourceLocation ID = CivilianAviation.locate("bell206_black");
    ...
    private final ModelPartRenderHandler<Bell206Black> model = new ModelPartRenderHandler<Bell206Black>()
            ...
            .add("propeller_main", (model, object, vcp, entity, ms, light, time, mpr) -> {
                ...
                if (alpha > 0.0f) BBModelRenderer.renderObjectInner(model, object, ms, vcp, light, time, entity,
                        new ModelPartRenderHandler<Bell206Black>().vertexConsumerProvider(TRANSLUCENT_PROVIDER),
    ...
    public Bell206BlackRenderer(EntityRendererProvider.Context context) { super(context); }
    @Override protected ModelPartRenderHandler<Bell206Black> getModel(AircraftEntity entity) { return model; }
}
