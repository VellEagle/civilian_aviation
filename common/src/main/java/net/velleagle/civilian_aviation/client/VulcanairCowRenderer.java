...
import net.velleagle.civilian_aviation.entity.VulcanairCow;

public class VulcanairCowRenderer extends AircraftEntityRenderer<VulcanairCow> {
    private static final ResourceLocation ID = CivilianAviation.locate("vulcanair_cow");
    ...
    private final ModelPartRenderHandler<VulcanairCow> model = new ModelPartRenderHandler<VulcanairCow>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<VulcanairCow>()
    ...
    public VulcanairCowRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<VulcanairCow> getModel(AircraftEntity entity) {
        return model;
    }
}
