...
import net.velleagle.civilian_aviation.entity.Bell206Police;

public class Bell206PoliceRenderer extends AircraftEntityRenderer<Bell206Police> {
    private static final ResourceLocation ID = CivilianAviation.locate("bell206_police");
    ...
    private final ModelPartRenderHandler<Bell206Police> model = new ModelPartRenderHandler<Bell206Police>()
            ...
            .add("propeller_main", (model, object, vcp, entity, ms, light, time, mpr) -> {
                ...
                if (alpha > 0.0f) BBModelRenderer.renderObjectInner(model, object, ms, vcp, light, time, entity,
                        new ModelPartRenderHandler<Bell206Police>().vertexConsumerProvider(TRANSLUCENT_PROVIDER),
    ...
    public Bell206PoliceRenderer(EntityRendererProvider.Context context) { super(context); }
    @Override protected ModelPartRenderHandler<Bell206Police> getModel(AircraftEntity entity) { return model; }
}
