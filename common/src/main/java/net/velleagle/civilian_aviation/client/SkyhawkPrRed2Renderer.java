...
import net.velleagle.civilian_aviation.entity.SkyhawkPrRed2;

public class SkyhawkPrRed2Renderer extends AircraftEntityRenderer<SkyhawkPrRed2> {
    private static final ResourceLocation ID = CivilianAviation.locate("skyhawk_pr_red2");
    ...
    private final ModelPartRenderHandler<SkyhawkPrRed2> model = new ModelPartRenderHandler<SkyhawkPrRed2>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<SkyhawkPrRed2>()
    ...
    public SkyhawkPrRed2Renderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<SkyhawkPrRed2> getModel(AircraftEntity entity) {
        return model;
    }
}
