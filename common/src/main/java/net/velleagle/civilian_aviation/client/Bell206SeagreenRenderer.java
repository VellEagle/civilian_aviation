...
import net.velleagle.civilian_aviation.entity.Bell206Seagreen;

public class Bell206SeagreenRenderer extends AircraftEntityRenderer<Bell206Seagreen> {
    private static final ResourceLocation ID = CivilianAviation.locate("bell206_seagreen");
    ...
    private final ModelPartRenderHandler<Bell206Seagreen> model = new ModelPartRenderHandler<Bell206Seagreen>()
            ...
            .add("propeller_main", (model, object, vcp, entity, ms, light, time, mpr) -> {
                ...
                if (alpha > 0.0f) BBModelRenderer.renderObjectInner(model, object, ms, vcp, light, time, entity,
                        new ModelPartRenderHandler<Bell206Seagreen>().vertexConsumerProvider(TRANSLUCENT_PROVIDER),
    ...
    public Bell206SeagreenRenderer(EntityRendererProvider.Context context) { super(context); }
    @Override protected ModelPartRenderHandler<Bell206Seagreen> getModel(AircraftEntity entity) { return model; }
}
