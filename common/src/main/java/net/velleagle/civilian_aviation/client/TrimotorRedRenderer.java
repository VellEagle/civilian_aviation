...
import net.velleagle.civilian_aviation.entity.TrimotorRed;

public class TrimotorRedRenderer extends AircraftEntityRenderer<TrimotorRed> {
    private static final ResourceLocation ID = CivilianAviation.locate("trimotor_red");
    ...
    private final ModelPartRenderHandler<TrimotorRed> model = new ModelPartRenderHandler<TrimotorRed>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<TrimotorRed>()
    ...
    public TrimotorRedRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<TrimotorRed> getModel(AircraftEntity entity) {
        return model;
    }
}
