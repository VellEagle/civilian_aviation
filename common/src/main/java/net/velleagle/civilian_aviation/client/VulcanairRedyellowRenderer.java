...
import net.velleagle.civilian_aviation.entity.VulcanairRedyellow;

public class VulcanairRedyellowRenderer extends AircraftEntityRenderer<VulcanairRedyellow> {
    private static final ResourceLocation ID = CivilianAviation.locate("vulcanair_redyellow");
    ...
    private final ModelPartRenderHandler<VulcanairRedyellow> model = new ModelPartRenderHandler<VulcanairRedyellow>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<VulcanairRedyellow>()
    ...
    public VulcanairRedyellowRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<VulcanairRedyellow> getModel(AircraftEntity entity) {
        return model;
    }
}
