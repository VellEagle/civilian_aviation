...
import net.velleagle.civilian_aviation.entity.ComancheYellow;

public class ComancheYellowRenderer extends AircraftEntityRenderer<ComancheYellow> {
    private static final ResourceLocation ID = CivilianAviation.locate("comanche_yellow");
    ...
    private final ModelPartRenderHandler<ComancheYellow> model = new ModelPartRenderHandler<ComancheYellow>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<ComancheYellow>()
    ...
    public ComancheYellowRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<ComancheYellow> getModel(AircraftEntity entity) {
        return model;
    }
}
