...
import net.velleagle.civilian_aviation.entity.TrimotorWhite;

public class TrimotorWhiteRenderer extends AircraftEntityRenderer<TrimotorWhite> {
    private static final ResourceLocation ID = CivilianAviation.locate("trimotor_white");
    ...
    private final ModelPartRenderHandler<TrimotorWhite> model = new ModelPartRenderHandler<TrimotorWhite>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<TrimotorWhite>()
    ...
    public TrimotorWhiteRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<TrimotorWhite> getModel(AircraftEntity entity) {
        return model;
    }
}
