...
import net.velleagle.civilian_aviation.entity.Pzl37LosGreen;

public class Pzl37LosGreenRenderer extends AircraftEntityRenderer<Pzl37LosGreen> {
    private static final ResourceLocation ID = CivilianAviation.locate("pzl37los_green");
    ...
    private final ModelPartRenderHandler<Pzl37LosGreen> model = new ModelPartRenderHandler<Pzl37LosGreen>()
            ...
            .add("propeller_l2", (model, object, vcp, entity, ms, light, time, mpr) -> {
                ...
                if (alpha > 0.0f) BBModelRenderer.renderObjectInner(model, object, ms, vcp, light, time, entity,
                        new ModelPartRenderHandler<Pzl37LosGreen>().vertexConsumerProvider(TRANSLUCENT_PROVIDER),
    ...
    public Pzl37LosGreenRenderer(EntityRendererProvider.Context context) { super(context); }
    @Override protected ModelPartRenderHandler<Pzl37LosGreen> getModel(AircraftEntity entity) { return model; }
}
