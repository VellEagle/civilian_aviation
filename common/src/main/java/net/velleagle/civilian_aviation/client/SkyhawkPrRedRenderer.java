...
import net.velleagle.civilian_aviation.entity.SkyhawkPrRed;

public class SkyhawkPrRedRenderer extends AircraftEntityRenderer<SkyhawkPrRed> {
    private static final ResourceLocation ID = CivilianAviation.locate("skyhawk_pr_red");
    ...
    private final ModelPartRenderHandler<SkyhawkPrRed> model = new ModelPartRenderHandler<SkyhawkPrRed>()
            // 染色パーツ（変更なし）
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<SkyhawkPrRed>()
    ...
    public SkyhawkPrRedRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<SkyhawkPrRed> getModel(AircraftEntity entity) {
        return model;
    }
}