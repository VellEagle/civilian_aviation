...
import net.velleagle.civilian_aviation.entity.SkyhawkPrBlackred;

public class SkyhawkPrBlackredRenderer extends AircraftEntityRenderer<SkyhawkPrBlackred> {
    private static final ResourceLocation ID = CivilianAviation.locate("skyhawk_pr_blackred");
    ...
    private final ModelPartRenderHandler<SkyhawkPrBlackred> model = new ModelPartRenderHandler<SkyhawkPrBlackred>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<SkyhawkPrBlackred>()
    ...
    public SkyhawkPrBlackredRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<SkyhawkPrBlackred> getModel(AircraftEntity entity) {
        return model;
    }
}
