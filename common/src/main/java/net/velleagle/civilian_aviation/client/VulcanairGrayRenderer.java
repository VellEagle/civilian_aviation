...
import net.velleagle.civilian_aviation.entity.VulcanairGray;

public class VulcanairGrayRenderer extends AircraftEntityRenderer<VulcanairGray> {
    private static final ResourceLocation ID = CivilianAviation.locate("vulcanair_gray");
    ...
    private final ModelPartRenderHandler<VulcanairGray> model = new ModelPartRenderHandler<VulcanairGray>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<VulcanairGray>()
    ...
    public VulcanairGrayRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<VulcanairGray> getModel(AircraftEntity entity) {
        return model;
    }
}
