...
import net.velleagle.civilian_aviation.entity.SkyhawkBrown;

public class SkyhawkBrownRenderer extends AircraftEntityRenderer<SkyhawkBrown> {
    private static final ResourceLocation ID = CivilianAviation.locate("skyhawk_brown");
    ...
    private final ModelPartRenderHandler<SkyhawkBrown> model = new ModelPartRenderHandler<SkyhawkBrown>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<SkyhawkBrown>()
    ...
    public SkyhawkBrownRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<SkyhawkBrown> getModel(AircraftEntity entity) {
        return model;
    }
}
