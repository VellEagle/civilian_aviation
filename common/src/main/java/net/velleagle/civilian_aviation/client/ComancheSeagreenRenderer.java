...
import net.velleagle.civilian_aviation.entity.ComancheSeagreen;

public class ComancheSeagreenRenderer extends AircraftEntityRenderer<ComancheSeagreen> {
    private static final ResourceLocation ID = CivilianAviation.locate("comanche_seagreen");
    ...
    private final ModelPartRenderHandler<ComancheSeagreen> model = new ModelPartRenderHandler<ComancheSeagreen>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<ComancheSeagreen>()
    ...
    public ComancheSeagreenRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<ComancheSeagreen> getModel(AircraftEntity entity) {
        return model;
    }
}
