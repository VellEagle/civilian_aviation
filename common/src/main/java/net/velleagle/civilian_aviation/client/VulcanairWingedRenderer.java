...
import net.velleagle.civilian_aviation.entity.VulcanairWinged;

public class VulcanairWingedRenderer extends AircraftEntityRenderer<VulcanairWinged> {
    private static final ResourceLocation ID = CivilianAviation.locate("vulcanair_winged");
    ...
    private final ModelPartRenderHandler<VulcanairWinged> model = new ModelPartRenderHandler<VulcanairWinged>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<VulcanairWinged>()
    ...
    public VulcanairWingedRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<VulcanairWinged> getModel(AircraftEntity entity) {
        return model;
    }
}
