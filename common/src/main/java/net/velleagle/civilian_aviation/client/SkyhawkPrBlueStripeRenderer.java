...
import net.velleagle.civilian_aviation.entity.SkyhawkPrBlueStripe;

public class SkyhawkPrBlueStripeRenderer extends AircraftEntityRenderer<SkyhawkPrBlueStripe> {
    private static final ResourceLocation ID = CivilianAviation.locate("skyhawk_pr_bluestripe");
    ...
    private final ModelPartRenderHandler<SkyhawkPrBlueStripe> model = new ModelPartRenderHandler<SkyhawkPrBlueStripe>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<SkyhawkPrBlueStripe>()
    ...
    public SkyhawkPrBlueStripeRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<SkyhawkPrBlueStripe> getModel(AircraftEntity entity) {
        return model;
    }
}
