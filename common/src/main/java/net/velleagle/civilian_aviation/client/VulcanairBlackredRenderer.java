...
import net.velleagle.civilian_aviation.entity.VulcanairBlackred;

public class VulcanairBlackredRenderer extends AircraftEntityRenderer<VulcanairBlackred> {
    private static final ResourceLocation ID = CivilianAviation.locate("vulcanair_blackred");
    ...
    private final ModelPartRenderHandler<VulcanairBlackred> model = new ModelPartRenderHandler<VulcanairBlackred>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<VulcanairBlackred>()
    ...
    public VulcanairBlackredRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<VulcanairBlackred> getModel(AircraftEntity entity) {
        return model;
    }
}
