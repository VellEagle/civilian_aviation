...
import net.velleagle.civilian_aviation.entity.SkyhawkBlueStripe;

public class SkyhawkBlueStripeRenderer extends AircraftEntityRenderer<SkyhawkBlueStripe> {
    private static final ResourceLocation ID = CivilianAviation.locate("skyhawk_bluestripe");
    ...
    private final ModelPartRenderHandler<SkyhawkBlueStripe> model = new ModelPartRenderHandler<SkyhawkBlueStripe>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<SkyhawkBlueStripe>()
    ...
    public SkyhawkBlueStripeRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<SkyhawkBlueStripe> getModel(AircraftEntity entity) {
        return model;
    }
}
