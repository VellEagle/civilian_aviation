...
import net.velleagle.civilian_aviation.entity.SkyhawkPrButter;

public class SkyhawkPrButterRenderer extends AircraftEntityRenderer<SkyhawkPrButter> {
    private static final ResourceLocation ID = CivilianAviation.locate("skyhawk_pr_butter");
    ...
    private final ModelPartRenderHandler<SkyhawkPrButter> model = new ModelPartRenderHandler<SkyhawkPrButter>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<SkyhawkPrButter>()
    ...
    public SkyhawkPrButterRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<SkyhawkPrButter> getModel(AircraftEntity entity) {
        return model;
    }
}
