...
import net.velleagle.civilian_aviation.entity.VulcanairGreen;

public class VulcanairGreenRenderer extends AircraftEntityRenderer<VulcanairGreen> {
    private static final ResourceLocation ID = CivilianAviation.locate("vulcanair_green");
    ...
    private final ModelPartRenderHandler<VulcanairGreen> model = new ModelPartRenderHandler<VulcanairGreen>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<VulcanairGreen>()
    ...
    public VulcanairGreenRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<VulcanairGreen> getModel(AircraftEntity entity) {
        return model;
    }
}
