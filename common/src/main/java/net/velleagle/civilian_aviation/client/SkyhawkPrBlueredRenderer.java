...
import net.velleagle.civilian_aviation.entity.SkyhawkPrBluered;

public class SkyhawkPrBlueredRenderer extends AircraftEntityRenderer<SkyhawkPrBluered> {
    private static final ResourceLocation ID = CivilianAviation.locate("skyhawk_pr_bluered");
    ...
    private final ModelPartRenderHandler<SkyhawkPrBluered> model = new ModelPartRenderHandler<SkyhawkPrBluered>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<SkyhawkPrBluered>()
    ...
    public SkyhawkPrBlueredRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<SkyhawkPrBluered> getModel(AircraftEntity entity) {
        return model;
    }
}
