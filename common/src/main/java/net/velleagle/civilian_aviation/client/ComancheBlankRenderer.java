...
import net.velleagle.civilian_aviation.entity.ComancheBlank;

public class ComancheBlankRenderer extends AircraftEntityRenderer<ComancheBlank> {
    private static final ResourceLocation ID = CivilianAviation.locate("comanche_blank");
    ...
    private final ModelPartRenderHandler<ComancheBlank> model = new ModelPartRenderHandler<ComancheBlank>()
            .add("dyed_body",
                    ...
                    (model, object, vertexConsumerProvider, entity, matrixStack, light, time, modelPartRenderer) -> {
                        ...
                        if (alpha > 0.0f) {
                            BBModelRenderer.renderObjectInner(
                                    ...
                                    light, time, entity,
                                    new ModelPartRenderHandler<ComancheBlank>()
    ...
    public ComancheBlankRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected ModelPartRenderHandler<ComancheBlank> getModel(AircraftEntity entity) {
        return model;
    }
}
